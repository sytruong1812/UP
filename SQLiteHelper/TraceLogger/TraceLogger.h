...
#define LOG_WARN_A(...)		TraceLogger::instance()->WarningA(__FUNCTION_NAME__,__LINE__,__VA_ARGS__)
#define LOG_ERROR_A(...)	TraceLogger::instance()->ErrorA(__FUNCTION_NAME__,__LINE__,__FILE__,__VA_ARGS__)
#define LOG_CRITICAL_A(...) TraceLogger::instance()->CriticalA(__FUNCTION_NAME__,__LINE__,__FILE__,__VA_ARGS__)
...
#define TRACE_CALL_A(...)	TraceLogger::instance()->TraceCallA(__FUNCTION_NAME__,__LINE__,__FILE__,__VA_ARGS__)
...
#define LOG_WARN_W(...)		TraceLogger::instance()->WarningW(__FUNCTION_NAME__,__LINE__,__VA_ARGS__)
#define LOG_ERROR_W(...)	TraceLogger::instance()->ErrorW(__FUNCTION_NAME__,__LINE__,__FILE__,__VA_ARGS__)
#define LOG_CRITICAL_W(...) TraceLogger::instance()->CriticalW(__FUNCTION_NAME__,__LINE__,__FILE__,__VA_ARGS__)
...
#define TRACE_CALL_W(...)	TraceLogger::instance()->TraceCallW(__FUNCTION_NAME__,__LINE__,__FILE__,__VA_ARGS__)
