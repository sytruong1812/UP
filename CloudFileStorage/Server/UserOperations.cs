    ...
    public class UserOperations
    {
        ...
        static public async Task<bool> ProcessLogin(Object session, Guid session_id, Request request, Response response)
        {
            try
            {
                ...
                {
                    UserManager.Instance.UpdateUserSession(session_id, STATES.LOGGED_IN, token_id, TimeSpan.FromMinutes(30));
                }
                else
                {
                    UserManager.Instance.AddUserSession(session_id, STATES.LOGGED_IN, (int)user_id, user_name, token_id, TimeSpan.FromMinutes(30));
                }
