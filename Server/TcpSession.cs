...
namespace CloudServer
{
    public class TcpSession : IDisposable
    {
        ...
        public virtual bool SendAsync(byte[] buffer, long offset, long size)
        {
            ...
            // Call the existing SendAsync method that accepts byte[]
        ...
        public virtual bool SendAsync(byte[] buffer)
        {
            ...
            {
                return true; // If there's no data to send, consider it successful
            }
        ...
        private void TryReceive()
        {
            ...
            //TODO: HTTP loop receive request
            while (process)
            {
                process = false;
                try
