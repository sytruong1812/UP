...
#if AEAD_MODES
#define CMAC         0     /* message authentication code (NIST SP 800-38B)   */
...
#define POLY1305     0     /* poly1305-AES mac (https://cr.yp.to/mac.html)    */
#endif
...
#define FF_X            3  /* algorithm type:  (1) for FF1, or (3) for FF3-1  */
#endif
...
char AES_GCM_decrypt( const uint8_t* key,     /* decryption key               */
                      ...
                      const uint8_t* aData,   /* added authentication data    */
                      const size_t aDataLen,  /* size of authentication data  */
                      const uint8_t* auTag,   /* size of tag (if any)         */
                      uint8_t* pntxt );       /* plain-text result            */
#endif /* GCM */
/**----------------------------------------------------------------------------
