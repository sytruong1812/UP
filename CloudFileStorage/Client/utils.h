...
namespace Helper 
{
    ...
    public:
        ...
        static std::wstring combinePath(const std::wstring& folderPath, const std::wstring& fileName);
    };
    ...
    public:
        ...
        static void replaceWideSubstring(std::wstring& str, const std::wstring& from, const std::wstring& to);
    };
};
