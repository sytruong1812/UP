...
namespace JWT.Builder
{
    ...
    public sealed class JwtBuilder
    {
        ...
        private bool CanEncode() =>
            (_algorithm != null || _algFactory != null) &&
            _jsonSerializerFactory != null &&
            _urlEncoder != null &&
            _jwt.Payload != null;
        ...
        private bool CanDecode()
        {
            ...
            if (_valParams.ValidateSignature)
                return _validator != null && (_algorithm != null || _algFactory != null);
        ...
        private bool CanDecodeHeader()
        {
            ...
            return _jsonSerializerFactory != null;
        }
