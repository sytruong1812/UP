...
namespace NetworkOperations 
{
    ...
    public:
        ...
        static DWORD GetStatusCode(HINTERNET hRequest);
        static std::string ReadResponseHeader(HINTERNET hRequest);
        static std::string ReadResponseContent(HINTERNET hRequest);
    private:
        DWORD statusCode;
